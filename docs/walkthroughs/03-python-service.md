...
```
 ...
 2. Classify changes                 → PREFLIGHT_CLASSIFIED
    ...
    octopus gate load-rule-pack --task-id "T-401" --stage "TASK_ENTRY" --loaded-rule-file "Octopus-agent-orchestrator/live/docs/agent-rules/00-core.md" --loaded-rule-file "Octopus-agent-orchestrator/live/docs/agent-rules/40-commands.md" --loaded-rule-file "Octopus-agent-orchestrator/live/docs/agent-rules/80-task-workflow.md" --loaded-rule-file "Octopus-agent-orchestrator/live/docs/agent-rules/90-skill-catalog.md"
    octopus gate classify-change --use-staged --task-id "T-401" --task-intent "Add order cancellation with refund"
    octopus gate load-rule-pack --task-id "T-401" --stage "POST_PREFLIGHT" --preflight-path "Octopus-agent-orchestrator/runtime/reviews/T-401-preflight.json" --loaded-rule-file "Octopus-agent-orchestrator/live/docs/agent-rules/00-core.md" --loaded-rule-file "Octopus-agent-orchestrator/live/docs/agent-rules/35-strict-coding-rules.md" --loaded-rule-file "Octopus-agent-orchestrator/live/docs/agent-rules/40-commands.md" --loaded-rule-file "Octopus-agent-orchestrator/live/docs/agent-rules/50-structure-and-docs.md" --loaded-rule-file "Octopus-agent-orchestrator/live/docs/agent-rules/70-security.md" --loaded-rule-file "Octopus-agent-orchestrator/live/docs/agent-rules/80-task-workflow.md" --loaded-rule-file "Octopus-agent-orchestrator/live/docs/agent-rules/90-skill-catalog.md"
